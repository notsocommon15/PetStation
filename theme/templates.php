        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href="<?php echo web_root?>"><span style="color: #0FA2FE;font-size: 30px">PET STATION</span></a>
            </div>
          </div>
...
<script type="text/javascript" language="javascript" src="<?php echo web_root; ?>js/jan.js"></script>
 <script type="text/javascript">
